...
//This is a REST controler and should receive request on path employees
@RestController
...
public class EmployeeResource {
    ...
    public ResponseEntity<EmployeeDto> findById(@PathVariable final Long id) {
        ...
        if (employee.isPresent()) {
            final EmployeeDto employeeConverted = employeeDtoConverter.convert(employee.get());
            return ResponseEntity.ok(employeeConverted);
        } else {
